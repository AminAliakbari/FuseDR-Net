...
from ModelsModify.RULMambaVAN import RULMambaVANNetModel
...
def setup_arg_parser():
    ...
    parser = argparse.ArgumentParser(description="RULMambaVAN RUL Prediction")
...
def run_single_experiment(exp_count, training_dataset, dataloaders, time_varying_known_reals, save_dir, args):
    ...
    best_model = RULMambaVANNetModel.load_from_checkpoint(trainer.checkpoint_callback.best_model_path)
